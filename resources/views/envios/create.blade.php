        ...
        <form method="POST" action="{{ route('envios.store') }}" id="form-envio" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre_cliente" id="nombre_cliente"
                    class="form-control @error('nombre_cliente') is-invalid @enderror" required maxlength="27"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="pedido" id="pedido" class="form-control @error('pedido') is-invalid @enderror"
                    required pattern="^P\d{7}|INCIDENCIA$" maxlength="20" value="{{ old('pedido') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="destinatario" id="destinatario"
                    class="form-control @error('destinatario') is-invalid @enderror" maxlength="27"
                    value="{{ old('destinatario') }}" {{ old('activar_destinatario') ? '' : 'disabled' }}>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="bultos" id="bultos" class="form-control @error('bultos') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <input type="number" name="palets" id="palets" class="form-control @error('palets') is-invalid @enderror"
